...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="w-full h-[500px] flex items-center justify-center overflow-hidden rounded-[12px]"
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          ...
          >
            <div 
              className="absolute w-20 h-20 rounded-full border opacity-70"
          ...
          {timelineData.map((item, index) => {
            ...
            return (
              <div
                key={item.id}
                ref={(el) => { nodeRefs.current[item.id] = el as HTMLDivElement; }}
              ...
              >
                ...
                <div
                  ...
                  `}
                  style={{
                    backgroundColor: isExpanded ? COLORS.accent : isRelated ? "rgba(245,158,11,0.5)" : COLORS.card,
                  }}
                >
                  <Icon size={16} style={{ color: isExpanded ? COLORS.page : isRelated ? COLORS.page : COLORS.text }} />
                </div>
                      ...
                      <div className="mt-4 pt-3 border-t border-white/10">
                        <div className="flex justify-between items-center text-xs mb-1">
                          <span className="flex items-center">
                            <Zap size={10} className="mr-1" style={{ color: COLORS.accent }} />
                            Energy Level
                          </span>
                        ...
                        <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${item.energy}%`,
                              background: `linear-gradient(90deg, ${COLORS.accent} 0%, #D97706 100%)`,
                            }}
                          ></div>
                        </div>
                      </div>
